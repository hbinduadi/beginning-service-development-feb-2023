namespace EmployeesApi.Adapters; public class OnCallDeveloperHttpAdapter
{
    private readonly HttpClient _httpClient; public OnCallDeveloperHttpAdapter(HttpClient httpClient)
    {
